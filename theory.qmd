...
<div class="page-body">
  ...
  <details class="plate">
    ...
    <div class="plate-body">
      <p>These are not optional background — they are constitutive of the methodology. Every design decision in SMM research follows from them. <em>Synthesised across Dervin (1983, 1992, 1998) — not a direct enumeration from any single paper.</em></p>
      ...
      <table class="compare-table">
        ...
        <tbody>
          <tr>
            ...
            <td>Foundational statement. Introduces the gap-bridge metaphor and the critique of the transmission model. The paper that established SMM as a distinct paradigm.</td>
          </tr>
          <tr>
